...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("CWMUSIC/assets/font2.ttf", 30)
    font = ImageFont.truetype("CWMUSIC/assets/font.ttf", 30)
    title_font = ImageFont.truetype("CWMUSIC/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("CWMUSIC/assets/play_icons.png")
